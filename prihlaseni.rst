...
- Přihlášení do aplikace lze provést na obrazovce, která se automaticky zobrazí každému nepřihlášenému uživateli. Postup pro přihlášení je stejný jako v kapitole _`prihlaseni.rst/Přihlášení pomocí jména a hesla`  **Přihlášení pomocí jména a hesla**.
